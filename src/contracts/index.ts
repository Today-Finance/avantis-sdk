...
export const TradingStorageContractABI = (TradingStorageABI as any).abi || TradingStorageABI;
export const TradingCallbacksContractABI = (TradingCallbacksABI as any).abi || TradingCallbacksABI;
export const PairInfosContractABI = (PairInfosABI as any).abi || PairInfosABI;
export const PairStorageContractABI = (PairStorageABI as any).abi || PairStorageABI;
export const PriceAggregatorContractABI = (PriceAggregatorABI as any).abi || PriceAggregatorABI;
export const VaultManagerContractABI = (VaultManagerABI as any).abi || VaultManagerABI;
export const USDCContractABI = (USDCABI as any).abi || USDCABI;
export const AVNTContractABI = (AVNTABI as any).abi || AVNTABI;
export const Multicall3ContractABI = (Multicall3ABI as any).abi || Multicall3ABI;
